...
```@docs
Comodo.togeometrybasics_mesh
```

## `edgecrossproduct`
```@docs
Comodo.edgecrossproduct
```
...
## `separate_vertices`
```@docs 
Comodo.separate_vertices
```

## `evenly_sample`
```@docs 
Comodo.evenly_sample
```
