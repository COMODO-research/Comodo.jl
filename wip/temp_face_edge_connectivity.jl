...
# # ax=Axis3(fig[1, 1], aspect = :data, xlabel = "X", ylabel = "Y", zlabel = "Z")
# # hp1=mesh!(ax,GeometryBasics.Mesh(V,F),color=:white, shading=FastShading, overdraw=false)
# # hp2=wireframe!(ax,GeometryBasics.Mesh(V,E[1:5]),transparency=true, depth_shift=-1.0f-3, color=:white)
