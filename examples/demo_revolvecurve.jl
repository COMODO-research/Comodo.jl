...
for testCase = 1:5
    ...
    fig = Figure(size=(1800,800), fontsize=10)

    ax1 = AxisGeom(fig[1, 1], title = "Revolved " * @sprintf("%.2f", θ) * " rad, direction=$direction1, periodicity=$periodicity, face_type=$face_type1")
    ...
    arrows3d!(ax1, [Point{3,Float64}(0.0,0.0,0.0)], [7*n], color=:green, lengthscale = 1.0)

    ax2 = AxisGeom(fig[1, 2], title = "Revolved " * @sprintf("%.2f", θ) * " rad, direction=$direction2, periodicity=$periodicity, face_type=$face_type2")
    ...
    arrows3d!(ax2, [Point{3,Float64}(0.0,0.0,0.0)], [7*n], color=:green, lengthscale = 1.0)

    ax3 = AxisGeom(fig[1, 3], title = "Revolved " * @sprintf("%.2f", θ) * " rad, direction=$direction3, periodicity=$periodicity, face_type=$face_type3")
    ...
    arrows3d!(ax3, [Point{3,Float64}(0.0,0.0,0.0)], [7*n], color=:green, lengthscale = 1.0)

    ax4 = AxisGeom(fig[2, 1], title = "Revolved " * @sprintf("%.2f", θ) * " rad, direction=$direction4, periodicity=$periodicity, face_type=$face_type4")
    ...
    arrows3d!(ax4, [Point{3,Float64}(0.0,0.0,0.0)], [7*n], color=:green, lengthscale = 1.0)

    ax5 = AxisGeom(fig[2, 2], title = "Revolved " * @sprintf("%.2f", θ) * " rad, direction=$direction5, periodicity=$periodicity, face_type=$face_type5")
    ...
    arrows3d!(ax5, [Point{3,Float64}(0.0,0.0,0.0)], [7*n], color=:green, lengthscale = 1.0)

    ax6 = AxisGeom(fig[2, 3], title = "Revolved " * @sprintf("%.2f", θ) * " rad, direction=$direction5, periodicity=$periodicity, face_type=$face_type5")
    ...
    arrows3d!(ax6, [Point{3,Float64}(0.0,0.0,0.0)], [7*n], color=:green, lengthscale = 1.0)
