...
F3, V3 = cylinder(r, h, nr, nh; direction=:negative, face_type=:tri_even, face_orientation=:inward)
...
ax3 = AxisGeom(fig[2, 1], title = """direction=:negative, face_type=:tri_even, face_orientation=:inward""")
