...
hs1 = scatter!(ax1, V,markersize=15, color=:black, depth_shift=-0.05f0)
...
hp2 = meshplot!(ax2, Fn, Vn, strokewidth=0.0, color=indMin, colormap=Makie.Categorical(:Spectral))
hs2 = scatter!(ax2, V,markersize=15, color=:black, depth_shift=-0.05f0)
