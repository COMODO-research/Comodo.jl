...
for testCase = 1:5
    ...
    F,V = simplicialcomplex(Vd,α; method=method, domain=domain)
    ...
    ax2 = AxisGeom(fig[1, 2], title="Simplicial complex, method=$method, domain=$domain", azimuth=-pi/2, elevation=pi/2)
